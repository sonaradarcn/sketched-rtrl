...
def fig_certificate(sweepdir, fname):
    ...
    # superseded by paper/figures/gen/regen_all.py; kept in sync with it (no "iff": see Sec. 7.4)
    ax.set_title("Certified contraction (ρ̄ < 1): bound stays tight;\nsustained ρ̄ ≥ 1: bound inflates")
